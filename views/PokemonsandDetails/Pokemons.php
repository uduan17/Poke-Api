  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link" href="../LoginandRegistro/login.php">Login</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="../LoginandRegistro/registro.php">Registro</a>
          </li>
        </ul>
  ...
  <div class="contenedor">
    ...
    ?>
      ...
      <div class="card" style="width: 12rem;">
        ...
        <button type="submit" class="button">Sobre <?php echo $name ?></button>
      </div>
      </form>
    <?php
    }
